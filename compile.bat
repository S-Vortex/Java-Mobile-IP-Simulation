...
jar -cfe bin/millsHomeAgent.jar HomeAgent ..\HomeAgent.java HomeAgent.class Frame.java ..\Frame.class ..\FrameHandler.java FrameHandler.class
jar -cfe bin/millsCorrespondent.jar Correspondent ..\Correspondent.java Correspondent.class ..\Frame.java Frame.class ..\FrameHandler.java FrameHandler.class
cd ..